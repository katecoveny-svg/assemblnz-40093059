...
export const sharedCoreAgents: Agent[] = [
  {
    ...
    color: "#D4A843", sector: "Shared Core", pack: "core", primaryModel: "claude",
  ...
  },
  {
    ...
    color: "#D4A843", sector: "Shared Core", pack: "core", primaryModel: "gemini",
...
const manaakiAgents: Agent[] = [
  {
    ...
    color: "#D4A843", sector: "Hospitality & Tourism", pack: "manaaki", primaryModel: "gemini",
...
const auahaAgents: Agent[] = [
  ...
  },
  {
    ...
    color: "#F0D078", sector: "Creative & Media", pack: "auaha", primaryModel: "claude",
...
const teKahuiReoAgents: Agent[] = [
  {
    ...
    color: "#D4A843", sector: "Māori Business Intelligence", pack: "te-kahui-reo", primaryModel: "claude",
